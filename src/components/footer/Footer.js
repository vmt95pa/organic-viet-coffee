          ...
          <Row align="center">
            <Col xs={24} md={14}>
              <div className="footer-subcribe__content">
                <p>Đăng ký nhận bản tin của Cà phê hữu cơ Việt để cập nhật những sản phẩm mới,<br /> nhận thông tin ưu đãi đặc biệt và thông tin giảm giá khác. </p>
              </div>
            </Col>
            <Col xs={24} md={10}>
      ...
      <div className="footer-bottom">
        <Container>
          <div className="footer-bottom__wrapper">
            <p>Copyright © 2023 Organic - Viet Coffee. Powered by Takatech</p>
            <img
